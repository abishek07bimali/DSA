...
public class Question1B {
    ...
    // constructor
    Question1B(int V,int[][] edges, int brokenNode) {
    ...
    public static void main(String[] args) {
        ...
        int brokenNode = 4;
        // Create a graph
        Question1B question1B = new Question1B(8,edges,brokenNode);

        System.out.println("Interuppted Networks:");
        //Get Disconencted Networks
        List<Integer> subgraphs = question1B.getDisconnectedSubgraphs();
